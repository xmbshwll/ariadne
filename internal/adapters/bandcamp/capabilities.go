...
// Capabilities reports which Bandcamp Adapter methods Ariadne can use.
//
// Source Input for both Entity Shapes and metadata Target Search; Bandcamp exposes no UPC or ISRC lookup.
